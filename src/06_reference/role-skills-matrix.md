...
**Purpose**: Quick reference to understand what skills and knowledge areas are expected for each role.

---

## Skills by Role

| Skill / Knowledge Area | Architect | Principal Engineer | Technical Lead | Engineering Manager | AIOps Architect |
|------------------------|-----------|-------------------|----------------|---------------------|-----------------|
| **System-Level Design** | ✓✓✓ | ✓✓ | ✓✓ | ✓ | ✓✓ |
...
1. **Identify your target role** - Find the column
2. **Check required skills** - See what's marked ✓✓✓
3. **Assess your current level** - Compare with your experience
4. **Focus your preparation** - Study areas marked ✓✓✓ first
5. **Use role-specific guides** - See `../04_roles/[role]/README.md`
