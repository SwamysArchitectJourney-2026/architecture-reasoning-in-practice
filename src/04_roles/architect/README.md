...
1. **System Design** - Architecture patterns, microservices, DDD, event-driven architecture
2. **Trade-offs at Scale** - Cost vs scale, simplicity vs flexibility, consistency vs availability
3. **Migrations & Modernization** - Legacy system modernization, migration strategies, risk management
...
1. **System Design Scenarios** (`../../05_evaluation/system-design/architect/`)
...
1. **Scenario Walkthroughs** (`../../05_evaluation/scenario-walkthroughs/architect/`)
